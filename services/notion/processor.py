...
@notion_router.post("/process-project-documents")
def process_project_documents_endpoint(project_name: str):
    return notion_processor.process_project_documents(project_name)

@notion_router.post("/extract-requirements")
def extract_requirements_endpoint(page_id: str):
    return notion_processor.extract_requirements_from_page(page_id)

@notion_router.post("/client-context")
def get_client_context_endpoint(client_name: str):
    return notion_processor.get_client_context(client_name) 