...
from shared.core.models import ProcessingResult, GeneratedIssue, LinearContext
from shared.services.ai_service import OpenAIService
from shared.services.linear_service import LinearService
# from shared.services.transcript_service import TranscriptService  # TODO: Implement or refactor to API calls
...
class AlphaMachineOrchestrator:
    ...
    def __init__(self):
        ...
        # self.transcript_service = TranscriptService()  # TODO: Implement or refactor to API calls
...
@linear_router.post("/process-transcript", response_model=ProcessingResult)
def process_transcript_endpoint():
    """Process a transcript and generate Linear issues."""
    result = orchestrator.process_transcript()
    return result

@linear_router.post("/create-issues")
def create_issues_endpoint(issues: List[GeneratedIssue]):
    """Create Linear issues from a list of generated issues."""
    created_issues = orchestrator.create_linear_issues(issues)
    return {"created_issues": created_issues}

@linear_router.post("/run-workflow")
def run_workflow_endpoint():
    """Run the full transcript processing and issue creation workflow."""
